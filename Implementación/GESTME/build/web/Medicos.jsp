...
<html lang="es">
    <head>
        ...
        <link href="css/estiloNuevo.css" rel="stylesheet" type="text/css"/>
        <link href="css/estilos1Nuevo.css" rel="stylesheet" type="text/css"/>
        ...
        <div id = "ventana">
            ...
            <div class="container">
                <div class="row">  
                    ...
                    <div class="col-md-6" >
                        <form name= "action" action = "eliminarMedico" method="post">
                            <label id= "buscar"> Cédula Profesional: </label>
                            <input id="cedula1" name= "buscar" type="text" class="buscar"
                                   placeholder= "Cédula Profesional" >
                            </br></br>


                            <label id="eliminar"> </label>  
                            <input type="submit" name="elimina" class="eliminarbtn" value="Eliminar Médico">
                            </br></br></br>


                            <label id="buscar"> </label>  
                            <input type="submit" name="busca" class="buscarbtn" value="Buscar Médico" >

                         
                        </form>

                    </div>
                    <form name="agregar" action = "agregarMedico" method="post">
                        <div class="col-md-6" >
                            ...
                            <input type="date" min="" max="2019-11-11" name="Fecha" data-date-format="YYYY-MM-DD" required placeholder="FechaNac" maxlength="">
                            ...
                            <input type="text" class="cedula" name="cedula"
                                   required placeholder= "Cédula Profesional" 
                                   pattern="[A-Za-z0-9]+" title="Solo acepta letras mayusculas y minusculas y numeros">
                            </br></br></br>
                        </div>
                </div>
